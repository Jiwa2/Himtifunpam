    ...
    <div className="struktur-wrapper">
      ...
      <div className="container">
        ...
        <div className="grid">
          ...
          <Card nama="Bilqis Nilam Cahya" jabatan="Staff" foto="/images/PSDM/Bilqis Nilam Cahya.png" />
          ...
          <Card nama="Nama" jabatan="Staff" foto="/images/user.png" />
          <Card nama="Nama" jabatan="Staff" foto="/images/user.png" />
          <Card nama="Arnta Salsabilla" jabatan="Staff" foto="/images/sosbud/Arinta Salsabilla.png" />
          <Card nama="Nama" jabatan="Staff" foto="/images/user.png" />
        </div>
