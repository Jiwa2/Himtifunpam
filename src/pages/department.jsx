      ...
      <div className="department-container">
        ...
        <div className="department-header-text">
          ...
          <p className="deskripsi-halaman">
            ...
            dari segala faktor. Kami memiliki berbagai bidang yang dapat kamu ketahui. 
        ...
        <div className="dept-list-wrapper">
            ...
            <div className={`dept-collapse-wrapper ${openDept.ristek ? "open" : ""}`}>
              <div className="dept-content-card">
                <div className="dept-profile-box">
                  ...
                  <h4 className="dept-kadep-name">Riset Dan Teknologi</h4>
                  ...
                  <div className="proker-list-wrapper">
                    <div className="proker-item">
                      <button className="proker-toggle-btn" onClick={() => toggleProker("proker1")}>
                        <span className="proker-icon">{openProker.proker1 ? "▼" : "▶"}</span> Collab HMTIF Unpam x HMTI UMJ
                      </button>
                      <div className={`proker-collapse-wrapper ${openProker.proker1 ? "open" : ""}`}>
                        <div className="proker-detail-panel">
                          ...
                          <div className="proker-detail-row">
                            ...
                            <span className="detail-value">: <span className="status-badge">(Selesai)</span></span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className={`proker-collapse-wrapper ${openProker.proker2 ? "open" : ""}`}>
                        <div className="proker-detail-panel">
                          <div className="proker-detail-row">
                            <span className="detail-dot"></span>
                            <span className="detail-label">Tanggal Pelaksanaan</span>
                            <span className="detail-value">: 13 - 19 Juni 2026</span>
                          </div>
                          <div className="proker-detail-row">
                            <span className="detail-dot"></span>
                            <span className="detail-label">Deskripsi Proker</span>
                          ...
                          <div className="proker-detail-row">
                            <span className="detail-dot"></span>
                            <span className="detail-label">Status Kegiatan</span>
                            <span className="detail-value">: <span className="status-badge">(Proses)</span></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="proker-item">
                      <button className="proker-toggle-btn" onClick={() => toggleProker("proker2")}>
                        <span className="proker-icon">{openProker.proker2 ? "▼" : "▶"}</span> Nama Proker
                      </button>
                      <div className={`proker-collapse-wrapper ${openProker.proker2 ? "open" : ""}`}>
                        <div className="proker-detail-panel">
                          <div className="proker-detail-row">
          ...
          <div className="dept-item">
            <button className="dept-toggle-btn" onClick={() => toggleDept("humas")}>
              <span className="toggle-icon">{openDept.humas ? "−" : "+"}</span> Department HUMAS
            </button>
            <div className={`dept-collapse-wrapper ${openDept.humas ? "open" : ""}`}>
              <div className="dept-content-card">
                <p style={{ textAlign: 'center', color: '#fff' }}>Konten Department HUMAS</p>
              </div>
            </div>
          </div>
